...
public class WETMapReduceTest extends Configured implements Tool {
	private static final Logger LOG = Logger.getLogger(WETMapReduceTest.class);
	
	/**
	 * Main entry point that uses the {@link ToolRunner} class to run the Hadoop job. 
	 */
	public static void main(String[] args) throws Exception {
		int res = ToolRunner.run(new Configuration(), new WETMapReduceTest(), args);
		System.exit(res);
	}
	...
	public int run(String[] arg0) throws Exception {
		...
		job.setJarByClass(WETMapReduceTest.class);
